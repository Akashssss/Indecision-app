...
function NavBar() {
  let links = [
    { name: "INDECISION", link: "/indecision" },
    ...
    <nav className=" shadow-md w-full top-0 left-0 mb-20">
      <div className="navbar-container md:flex justify-between  bg-yellow-50  items-center   text-yellow-900 py-4 md:px-10 px-7 ">
        <div className="navbar-left cursor-pointer shrink-0">
          ...
          <sub className="font-bold ">Let us Build</sub>
        </div>
        ...
        <div
          className={`navbar-right cursor-pointer md:static absolute bg-yellow-50 left-0 md:z-auto z-[-1] md:w-auto w-full md:pl-0 pl-9
          ...
          <div className="navbar-navigation">
            <ul className="md:flex md:items-center md:pb-0 pb-4 sh">
              ...
              <div className="navbar-login-signup shrink-0">
                <button className=" bg-orange-800 text-white py-2 px-6 rounded md:ml-8 hover:bg-orange-600 duration-500 shadow md:my-0 my-7 ">
                  Get Started !
                </button>
              </div>
            </ul>
